        ...
        <table className="w-full min-w-full border-collapse">
          <thead>
            <tr className="bg-gradient-to-r from-purple-600 via-purple-700 to-purple-800">
              ...
              <th className="px-6 py-4 text-sm font-semibold tracking-wider text-center text-white uppercase border-b border-purple-500">View CV</th>
              <th className="px-6 py-4 text-sm font-semibold tracking-wider text-center text-white uppercase border-b border-purple-500 last:rounded-tr-xl">Status</th>
            </tr>
          </thead>
              ...
              >
                ...
                <td className="px-6 py-4 text-sm text-center whitespace-nowrap">
                  ...
                  applicant.status === "Rejected" ? (
                    ...
                    <select
                      className="px-3 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
