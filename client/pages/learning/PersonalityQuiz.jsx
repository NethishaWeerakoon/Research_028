      ...
      <div className="space-y-6">
        ...
        <div className="bg-gray-200 rounded-lg p-4 shadow-md">
          <label className="block text-2xl font-semibold text-gray-700 mb-2">
            <p>You have been assigned to lead a project for your company that requires collaboration with a team of people from different departments.</p>
            <p>The deadline is tight, and there is a conflict between two team members about how to proceed.</p>
            <p>One prefers a structured, detailed approach, while the other wants to keep things flexible and open-ended.</p>
            <p>You also need to present your progress to upper management soon.</p>
            <p><strong>How would you handle this situation?</strong></p>
          </label>
