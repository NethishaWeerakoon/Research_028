...
const PersonalityDetails = ({ personalityType }) => {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto bg-white shadow-xl rounded-lg p-6 border border-gray-300 transition-transform transform hover:scale-[1.02] grid grid-cols-2 gap-6">
      ...
      {/* Cons */}
      <div>
        <h3 className="text-lg font-semibold text-red-700 mb-2">Challenges</h3>
        <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
          {cons.map((item, index) => (
      ...
      {/* Careers */}
      <div>
        <h3 className="text-lg font-semibold text-blue-700 mb-2">Ideal Careers</h3>
        <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
      ...
      {/* Communication */}
      <div>
        <h3 className="text-lg font-semibold text-purple-700 mb-2">Communication Style</h3>
        <p className="text-sm text-gray-700">{communication}</p>
      </div>

      {/* Environment */}
      <div>
        <h3 className="text-lg font-semibold text-yellow-700 mb-2">Preferred Environment</h3>
        <p className="text-sm text-gray-700">{environment}</p>
      </div>

      {/* Growth Tips */}
      <div className="col-span-2">
        <h3 className="text-lg font-semibold text-emerald-700 mb-2">Growth Tips</h3>
        <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
