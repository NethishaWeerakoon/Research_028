...
export default function ResumeTemplatePro() {
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-b from-indigo-10 to-white p-8 flex flex-col items-center font-sans"
      style={{ fontFamily: "'Inter', sans-serif" }}
    >
      <div
        id="resume-preview"
        className="bg-white max-w-5xl w-full rounded-3xl shadow-2xl border border-gray-200 overflow-hidden print:max-w-full print:shadow-none print:border-none animate-fadeIn"
        style={{ fontSize: "11pt", lineHeight: 1.5 }}
      >
        {/* Header */}
        <header className="bg-indigo-200 text-black p-10 flex flex-col md:flex-row items-center gap-8 print:bg-white print:text-black print:p-6">
          <div className="w-36 h-36 rounded-full overflow-hidden border-4 border-white shadow-lg flex-shrink-0">
            {profilePhotoBase64 ? (
              ...
              <div className="w-full h-full bg-gray-300 flex items-center justify-center font-semibold text-xl text-gray-600 select-none">
                Photo
              </div>
            )}
          </div>
            ...
            <div className="mt-2 flex flex-col md:flex-row md:space-x-12 text-lg font-semibold print:text-base">
              ...
              <div className="flex items-center space-x-4 print:text-black">
                {formData.github && (
                  ...
                  >
                    <LinkIcon className="w-6 h-6" /> GitHub
                  </a>
                )}
                {formData.linkedin && (
                  <a
                    ...
                    className="flex items-center gap-1 hover:underline"
                  >
                    <LinkIcon className="w-6 h-6" /> LinkedIn
                  </a>
                )}
                {formData.portfolio && (
                  <a
                    ...
                    className="flex items-center gap-1 hover:underline"
                  >
                    <LinkIcon className="w-6 h-6" /> Portfolio
                  </a>
                )}
              </div>
            </div>
        ...
        <main className="p-10 grid grid-cols-1 md:grid-cols-3 gap-12 print:p-6">
          ...
          <section className="space-y-10 col-span-1 md:col-span-1">
            ...
            <div>
              ...
              {formData.education?.length ? (
                formData.education.map((edu, i) => (
                  <div
                    key={i}
                    className="mb-6 pl-4 border-l-4 border-indigo-600"
                  >
                    ...
                    <p className="italic text-indigo-600 print:text-black">{edu.timeRange}</p>
                  </div>
                ))
              ) : (
            ...
            <div>
              ...
              <div className="bg-indigo-50 rounded-xl p-4 space-y-4 print:bg-white">
                <div>
          ...
          <section className="col-span-1 md:col-span-2 space-y-10">
              ...
              {formData.workExperience?.length ? (
                formData.workExperience.map((work, i) => (
                  <article key={i} className="mb-8 print:mb-4">
                    <div className="flex justify-between border-l-4 border-purple-600 pl-5 py-1 mb-1 print:pl-3 print:mb-1">
                    ...
                    <p className="text-purple-900 font-semibold mb-1 print:text-black">{work.company}</p>
            ...
            {quizResults?.quizAttempts?.length > 0 && (
              <div>
                ...
                <p className="mb-1 font-semibold text-indigo-700 print:text-black">
                  Learning Type: {quizResults.learningType}
                </p>
                <p className="mb-4 font-semibold text-indigo-700 print:text-black">
                ...
                <table className="w-full border-collapse border border-gray-300 text-left text-gray-700 print:text-black rounded-md overflow-hidden">
                  <thead className="bg-indigo-100 print:bg-gray-200">
                    <tr>
      ...
      <div className="mt-8 flex gap-4 justify-center flex-wrap">
        <label
          ...
          className="cursor-pointer bg-indigo-700 hover:bg-indigo-800 text-white font-semibold px-6 py-3 rounded-full shadow-lg transition duration-300 select-none"
        ...
        <button
          ...
          className="bg-gray-900 hover:bg-black text-white font-semibold px-6 py-3 rounded-full shadow-lg transition duration-300"
        >
          Download PDF
        </button>
      </div>
      ...
      <style>{`
        .section-title {
          @apply text-3xl font-extrabold mb-6 border-b-4 border-indigo-600 pb-1;
        }
        .animate-fadeIn {
