      ...
      <Navbar.Collapse>
        ...
        {currentUser?.roleType === "Job Seeker" && (
          <>
            ...
            <Navbar.Link
              active={path === "/personality-type-quiz"}
              as={"div"}
              style={{
                color: path === "/personality-type-quiz" ? "#384ae2" : "#000",
              }}
              className="text-md"
            >
              <Link to="/personality-type-quiz">PERSONALITY TEST</Link>
            </Navbar.Link>
            <Navbar.Link
              active={path === "/personality-type-test"}
              as={"div"}
              style={{
                color: path === "/personality-type-test" ? "#384ae2" : "#000",
              }}
              className="text-md"
            >
              <Link to="/personality-type-test">PERSONALITY QUIZ</Link>
            </Navbar.Link>
            <Navbar.Link
