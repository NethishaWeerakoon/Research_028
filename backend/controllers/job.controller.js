      ...
      try {
        ...
        try {
          const apiResponse = await axios.post(
            `${process.env.FLASH_BACKEND}/recruitment-project/vectorsearch/jobs/`,
            {
...
const searchJobs = async (req, res) => {
  ...
  try {
    const response = await axios.post(
      `${process.env.FLASH_BACKEND}/recruitment-project/vectorsearch/jobs/search/`,
      {
        query_text: jobType,
        n_results: jobCount,
      }
...
const deleteJob = async (req, res) => {
  ...
  try {
    ...
    const externalResponse = await axios.delete(
      `${process.env.FLASH_BACKEND}/recruitment-project/vectorsearch/jobs/${job_id}`
    );
